...
!(Final assembly, as seen in FreeCAD)[images/3d-render-badge-final.png]
!(Exploded assembly, as seen in FreeCAD)[images/3d-render-pcb-with-shell.png]
!(Main PCB)[images/badge_pcb_render.jpg]
